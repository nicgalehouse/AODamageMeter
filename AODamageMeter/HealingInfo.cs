...
namespace AODamageMeter
{
    ...
    public class HealingInfo
    {
        ...
        // FightPet registration handling guarantees if source has a fight pet master, that master has a healing info for Target.
        public long MastersOrOwnPotentialHealingPlusPets => Source.FightPetMaster?.HealingDoneInfosByTarget[Target].PotentialHealingPlusPets ?? PotentialHealingPlusPets;
        ...
        public double? PercentOfMastersOrOwnPotentialHealingPlusPets => PotentialHealing / MastersOrOwnPotentialHealingPlusPets.NullIfZero();

        public double? PercentOfMastersOrOwnPotentialHealingDoneDonePlusPets
            => Source.IsFightPet
            ? PotentialHealing / Source.FightPetMaster.PotentialHealingDonePlusPets.NullIfZero()
            : PotentialHealing / Source.PotentialHealingDonePlusPets.NullIfZero();
        public double? PercentOfMastersOrOwnMaxPotentialHealingDonePlusPets
            => Source.IsFightPet
            ? PotentialHealing / Source.FightPetMaster.MaxPotentialHealingDonePlusPets.NullIfZero()
