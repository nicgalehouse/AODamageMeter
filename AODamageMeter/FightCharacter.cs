...
namespace AODamageMeter
{
    public class FightCharacter
    {
        ...
        public double PercentOfTotalDamageDone => Fight.TotalDamageDone == 0 ? 0 : 100 * DamageDone / (double)Fight.TotalDamageDone;
        public double PercentOfMaxDamageDone => Fight.MaxDamageDone == 0 ? 0 : 100 * DamageDone / (double)Fight.MaxDamageDone;
        public double ActiveDPS => ActiveDuration.Seconds <= 1 ? DamageDone : DamageDone / (double)ActiveDuration.Seconds;
        public double FullDPS => Fight.Duration.Value.Seconds <= 1 ? DamageDone : DamageDone / (double)Fight.Duration.Value.Seconds;
        ...
        public double CastSuccessChance => CastAttempts == 0 ? 0 : 100 * CastSuccessCount / (double)CastAttempts;
        public double CastResistedChance => CastAttempts == 0 ? 0 : 100 * CastResistedCount / (double)CastAttempts;
        public double CastCounteredChance => CastAttempts == 0 ? 0 : 100 * CastCounteredCount / (double)CastAttempts;
        public double CastAbortedChance => CastAttempts == 0 ? 0 : 100 * CastAbortedCount / (double)CastAttempts;
